...
class GenImagesAndLabels(Dataset):  # for training/testing
    ...
    def gen(self):
        ...
        for index in range(len(self.img_files)):
            ...
            #print(index)
            os.makedirs("../DATAORG/data_aug07_11/data_aug_11_11/imgworst_4/images/", exist_ok=True)
            os.makedirs("../DATAORG/data_aug07_11/data_aug_11_11/imgworst_4/labels/", exist_ok=True)
            cv2.imwrite("../DATAORG/data_aug07_11/data_aug_11_11/imgworst_4/images/111100000004"+str(index)+".jpg",img)
            txt_file=open("../DATAORG/data_aug07_11/data_aug_11_11/imgworst_4/labels/111100000004"+str(index)+".txt",'w')
            for item in labels:
                item=item.tolist()
                item[0]=int(item[0])
                string =""
