...
os.makedirs("../DATASUBMIT_11_11/data_aug011_11/data_aug_difficult/imgworst_1/images/", exist_ok=True)
os.makedirs("../DATASUBMIT_11_11/data_aug011_11/data_aug_difficult/imgworst_1/labels/", exist_ok=True)
...
for txt in file:
    ...
    for i in coor:
        ...
        if i[0] == '1':
            ...
            resave = "2"+" "+str(coor_text_XC)+" "+str(coor_text_YC)+" "+str(coor_text_WC)+" "+str(coor_text_HC)+"\n"
            cv2.imwrite("../DATASUBMIT_11_11/data_aug011_11/data_aug_difficult/imgworst_1/images/00000001"+str(index)+".jpg",crop_img)
            txt_file=open("../DATASUBMIT_11_11/data_aug011_11/data_aug_difficult/imgworst_1/labels/00000001"+str(index)+".txt",'w')
